...
void Application::Render()
{
	...
	glClearColor(objectColorLoc, 0.67f, 0.84f, 0.90f);
...
void Application::BuildHouseRoof() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
...
void Application::BuildPoolSurface() 
{
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
...
void Application::BuildPinggiranPool_1() 
{
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
...
void Application::BuildStandLampu() 
{
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
...
void Application::BuildChairBottom() {
	// load image into texture memory
	// ------------------------------
	// Load and create a texture 
...
void Application::DrawStreet()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0.5, -.47, 0));
	model = glm::scale(model, glm::vec3(5, 0.1, 50));
...
void Application::DrawHouse()
{
	...
	//kiri
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-5, 1, -30));
	model = glm::scale(model, glm::vec3(6, 7, 15));
	...
	//kanan
	glm::mat4 model2;
	model2 = glm::translate(model2, glm::vec3(-2, 1, -30));
	model2 = glm::scale(model2, glm::vec3(10, 7, 10));
...
void Application::DrawHouseRoof()
{
	glUseProgram(shaderProgram);
	...
	//kiri
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-2, 4.5, -30));
	model = glm::scale(model, glm::vec3(15, 0.5, 18));
...
void Application::DrawPoolSurface() 
{
	glUseProgram(shaderProgram);
	...
	//kiri
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-3, 0.2, -44));
	model = glm::scale(model, glm::vec3(10, 0, 5));
...
void Application::DrawPinggiranPool_1()
{
	glUseProgram(shaderProgram);
	...
	//kiri
	glm::mat4 model;//depan
	model = glm::translate(model, glm::vec3(-3, 0.1, -41.5));
	...
	glm::mat4 model2;
	model2 = glm::translate(model2, glm::vec3(-3, 0.1, -46.5));
	model2 = glm::scale(model2, glm::vec3(9, 0.5, 0.5));
	...
	glm::mat4 model3;
	model3 = glm::translate(model3, glm::vec3(-7.75, 0.1, -44));
	model3 = glm::scale(model3, glm::vec3(0.5, 0.5, 5.5));
	...
	glm::mat4 model4;
	model4 = glm::translate(model4, glm::vec3(1.75, 0.1, -44));
	model4 = glm::scale(model4, glm::vec3(0.5, 0.5, 5.5));
...
void Application::DrawStandLampu() 
{
	glUseProgram(shaderProgram);
...
void Application::DrawWindow()
{
	...
	//kiri
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-5, 2, -22.6));
	model = glm::scale(model, glm::vec3(4, 2, 0.4));
...
void Application::DrawChair()
{
	for (int i = 0; i < 2; i++) {
		...
		//alas
		glm::mat4 model;
		model = glm::translate(model, glm::vec3(-11, 0.5, (-25 - 8 * i)));
		model = glm::scale(model, glm::vec3(2, 0.1, 4));
		...
		//Sandaran
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(-11, 1, (-25 - 8 * i)));
		model2 = glm::scale(model2, glm::vec3(0.3, 1, 4));
...
void Application::DrawChairBottom()
{
	for (int i = 0; i < 2; i++) {
		...
		glm::mat4 model;
		model = glm::translate(model, glm::vec3(-11, 0, (-25-8*i)));
		model = glm::scale(model, glm::vec3(0.8, 1, 4));
...
void Application::DrawWall()
{
		...
		//depan kiri
		glm::mat4 model;
		model = glm::translate(model, glm::vec3(-8.2, 0, -14));
		model = glm::scale(model, glm::vec3(12.4, 3, 0.5));
