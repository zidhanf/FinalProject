...
void Application::DrawStreet()
{
	...
	model = glm::scale(model, glm::vec3(4, 0.1, 50));
...
void Application::DrawHouse()
{
	...
	//kiri
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-5, 0, -30));
	...
	//kanan
	glm::mat4 model2;
	model2 = glm::translate(model2, glm::vec3(-2, 0, -30));
...
void Application::DrawHouseRoof()
{
	...
	//kiri
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(-2, 3.5, -30));
